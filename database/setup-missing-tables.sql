...
ALTER TABLE transactions
ADD COLUMN IF NOT EXISTS goal_id UUID REFERENCES goals(id) ON DELETE
SET NULL;
ALTER TABLE transactions
ADD COLUMN IF NOT EXISTS budget_id UUID REFERENCES budgets(id) ON DELETE
SET NULL;
ALTER TABLE transactions
...
END $$;
DO $$ BEGIN CREATE TYPE goal_status AS ENUM ('active', 'completed', 'overdue');
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
-- =====================================================
...
ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();
-- =====================================================
-- STEP 5.6: Create Forex entries table
-- =====================================================
...
-- =====================================================
-- STEP 11.6: Create RLS policies for Forex entries
-- =====================================================
