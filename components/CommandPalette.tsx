...
const NAV_COMMANDS = (router: ReturnType<typeof useRouter>): Command[] => [
  ...
  { id: "stocks", label: "Stocks", icon: CandlestickChart, type: "page", action: () => router.push("/investments?tab=stocks") },
  { id: "mutual-funds", label: "Mutual Funds", icon: Coins, type: "page", action: () => router.push("/investments?tab=mutual-funds") },
  { id: "gold", label: "Gold", icon: Coins, type: "page", action: () => router.push("/investments?tab=gold") },
